        ...
        NavigationView {
            ZStack {
                ...
                Form {
                    ...
                    // The intro toggle sits with the launch log below, not here: they
                    // occupy the same screen at the same moment and turning the log on
                    // hides the intro, so separating them would make that look like a bug.
                    Section {
